...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_type", type=str, default="gpt-4-0613", choices=["gpt-3.5-turbo", "gpt-3.5-turbo-1106", "gpt-4-0613", "gpt-4-1106-preview",'gpt-4o'], help="Type of the model used to evaluate.")
